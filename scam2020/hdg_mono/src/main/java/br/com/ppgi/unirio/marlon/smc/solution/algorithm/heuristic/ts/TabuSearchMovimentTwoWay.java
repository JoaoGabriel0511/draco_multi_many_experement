...
public class TabuSearchMovimentTwoWay extends TabuSearch{
	
	private long[][] tabuList;
    
    public TabuSearchMovimentTwoWay(ResultWriter out,String suffix){
            super(out, suffix);
            NAME = "TabuSearchMovimentTwoWay";
	}
    ...
    protected void addTabu(long iterationN, int module, int cluster, int modulePositionBefore) {
        ...
        tabuList[module][cluster] = iterationN;
    }
