...
public class GeneralizedSpread
{
	...
	static jmetal.qualityIndicator.util.MetricsUtil utils_;
	...
	public double generalizedSpread(double[][] paretoFront, double[][] paretoTrueFront, int numberOfObjectives)
	{
		...
		Comparator<double[]> localComparator = new jmetal.qualityIndicator.util.LexicoGraphicalComparator();
	...
	public static void main(String args[])
	{
		...
		// Obtain delta value
		double value = qualityIndicator.generalizedSpread(solutionFront, trueFront, (new Integer(args[2])).intValue());
