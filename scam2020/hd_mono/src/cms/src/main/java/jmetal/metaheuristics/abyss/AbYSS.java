...
public class AbYSS extends Algorithm
{
	 ...
	 * the diversification method. By default it takes the value 4 (see the
	 ...
	 * 
	 * @param build if true, indicates that the reference has to be build for
	 *            the first time; if false, indicates that the reference set has
	 *            to be updated with new solutions
	 * @throws JMException
	 */
