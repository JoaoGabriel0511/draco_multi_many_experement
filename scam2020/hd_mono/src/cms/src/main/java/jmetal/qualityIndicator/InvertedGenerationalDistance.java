...
{
	jmetal.qualityIndicator.util.MetricsUtil utils_; // utils_ is used to access
	// to the
	...
	public static void main(String args[])
	{
		...
		double value = qualityIndicator.invertedGenerationalDistance(solutionFront, trueFront, (new Integer(args[2])).intValue());
