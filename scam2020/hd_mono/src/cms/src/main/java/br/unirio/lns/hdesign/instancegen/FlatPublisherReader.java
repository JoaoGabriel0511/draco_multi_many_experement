...
/**
 * Classe respons�vel por ler um arquivo criado pelo gerador de inst�ncias
 * 
...
public abstract class FlatPublisherReader
{
	...
	/**
	 * Gera uma exce��o de leitura do arquivo, dada a mensagem
	 */
	...
	/**
	 * M�todo abstrato para registrar uma entidade vinda do arquivo
	 */
	...
	/**
	 * M�todo abstrato para registrar um relacionamento vindo do arquivo
	 */
	...
	/**
	 * Carrega um arquivo flat criado pelo gerador de inst�ncias
	 */
